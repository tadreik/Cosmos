...
open class CosmosView: UIView {
    ...
    public var totalStars: Int = CosmosDefaultSettings.totalStars {
        didSet {
    ...
    public var filledColor: UIColor = CosmosDefaultSettings.filledColor {
        didSet {
            settings.filledColor = filledColor
        }
    }
    
    public var emptyColor: UIColor = CosmosDefaultSettings.emptyColor {
        didSet {
            settings.emptyColor = emptyColor
        }
    }
    
    public var emptyBorderColor: UIColor = CosmosDefaultSettings.emptyBorderColor {
        didSet {
    ...
    public var filledBorderColor: UIColor = CosmosDefaultSettings.filledBorderColor {
        didSet {
    ...
    public var fillMode: Int = CosmosDefaultSettings.fillMode.rawValue {
        didSet {
            settings.fillMode = StarFillMode(rawValue: fillMode) ?? CosmosDefaultSettings.fillMode
        }
    }
    
    public var textSize: Double = CosmosDefaultSettings.textSize {
        didSet {
    ...
    public var textColor: UIColor = CosmosDefaultSettings.textColor {
        didSet {
            settings.textColor = textColor
        }
    }
    
    public var updateOnTouch: Bool = CosmosDefaultSettings.updateOnTouch {
        didSet {
